...
applyrules(Client *c)
{
	...
	for (i = 0; i < LENGTH(rules); i++) {
		...
		&& (!r->instance || strstr(instance, r->instance)))
		{
			...
			c->tags |= r->tags;
			c->activeopacity = (r->activealpha != -1) ? r->activealpha : c->activeopacity;
			c->inactiveopacity = (r->inactivealpha != -1) ? r->inactivealpha : c->inactiveopacity;
